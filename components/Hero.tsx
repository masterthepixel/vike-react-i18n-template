      ...
      <div className="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        <div className="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-8">
          ...
          <div className="mt-24 sm:mt-32 lg:mt-16">
            <a href="#" className="inline-flex space-x-6">
              <span className="rounded-full bg-indigo-500/10 px-3 py-1 text-sm/6 font-semibold text-indigo-400 ring-1 ring-indigo-500/20 ring-inset">
                <LocaleText>What's new</LocaleText>
              </span>
              <span className="inline-flex items-center space-x-2 text-sm/6 font-medium text-gray-300">
                <span><LocaleText>Just shipped v1.0</LocaleText></span>
          ...
          <p className="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">
            <LocaleText>Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat.</LocaleText>
          </p>
          <div className="mt-10 flex items-center gap-x-6">
            ...
            >
              <LocaleText>Get started</LocaleText>
            </a>
            <a href="#" className="text-sm/6 font-semibold text-white">
              <LocaleText>Learn more</LocaleText> <span aria-hidden="true">→</span>
            </a>
          </div>
        </div>
